...
public class CrazyLambdas {
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        return runnable -> runningThreadSupplier(runnable).get();
    }
...
//        return Comparator.comparing(mapper);
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (o1, o2) -> {
            ...
            if (result == 0) {
                Comparator<U> comparator1 = Comparator.naturalOrder();
                return comparator1.compare(mapper.apply(o1), mapper.apply(o2));
            }
            return result;
        };
    }
