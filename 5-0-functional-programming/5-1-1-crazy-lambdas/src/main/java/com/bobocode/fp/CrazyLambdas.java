...
public class CrazyLambdas {
    ...
    public static IntSupplier randomIntSupplier() {
        return () -> new Random().ints().limit(1).min().getAsInt();
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return (bound) -> new Random().ints(0, bound).findAny().getAsInt();
    }
    ...
    public static Function<Runnable, Supplier<Thread>> runnableToThreadSupplierFunction() {
        return (runnable) -> () -> getThread(runnable);
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (unaryOperator, intPredicate) -> operand -> intPredicate.test(operand) ? unaryOperator.applyAsInt(operand) : operand;
    }
