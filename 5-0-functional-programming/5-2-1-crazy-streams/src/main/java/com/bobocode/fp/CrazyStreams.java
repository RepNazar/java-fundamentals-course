...
public class CrazyStreams {
    ...
    public int getNumOfLettersInFirstAndLastNames() {
        return Stream.of(accounts.stream().map(Account::getFirstName), accounts.stream().map(Account::getLastName))
                .flatMapToInt(stringStream -> stringStream.mapToInt(String::length))
                .sum();
    }
